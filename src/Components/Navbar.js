    ...
    return (
        ...
        <div className="container-fluid">
            ...
            <div className="offcanvas-body">
                ...
                <ul className="dropdown-menu dropdown-menu-dark mb-5" aria-labelledby="navbardarkDropdownMenuLink">
                ...
                <form>
                    <h3>Sign Up</h3>
                    <input type="text" className="box" placeholder="Enter Your Full name" required />
                    <input type="Number" className="box" placeholder="Enter Your Mobile No." required />
                    <input type="email"className="box" placeholder="Enter Your email" required />
                    <input type="date" class= 'box' placeholder="enter your date of birth" required />
